  ...
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'nik':'Bedfordshire',
        'name':'Daryl Prohaska',
        'email':'Sofia.Graham@gmail.com',
        'username':'Miracle98',
        'department':'program',
        'lokasi':'demand-driven',
        'grade':'Optimization',
        'jabatan':'Marketing',
        'no_hp':'Developer',
        'email_verified_at':'disintermediate',
        'avatar':'Seamless',
        'password':'tx62tJwsUzhQLey',
        'join_date':'2023-08-29T14:15:29.489Z',
        'remember_token':'withdrawal',
        'userType':authConstant.USER_TYPES.Admin,
        'created_at':'2024-04-08T01:26:18.787Z',
        'updated_at':'2023-08-06T15:20:05.945Z',
        'role_name':'FTP',
        'role_approval':435,
        'mobileNo':'(094) 188-1582'
      });
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Sofia.Graham@gmail.com', });
